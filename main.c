...
/*   Updated: 2022/01/31 17:48:11 by pleveque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	verify_pressed(t_screen *screen_data)
{
	...
	else if (keycode == A_TOUCH || keycode == D_TOUCH)
	{
...
int	main(int argc, char **argv)
{
	...
	mlx_hook(screen_data.win, 3, 1L << 0, on_release, &screen_data);
